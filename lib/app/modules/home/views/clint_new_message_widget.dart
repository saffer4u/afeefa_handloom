...
import '../controllers/clint_chat_controller.dart';

class ClintNewMessageWidget extends StatelessWidget {
  const ClintNewMessageWidget({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: TextFormField(
              controller: Get.find<ClintChatController>().messageController,
          ...
          FloatingActionButton(
            ...
            backgroundColor: royal,
            mini: true,
            onPressed: Get.find<ClintChatController>().sendMessage,
            child: Icon(
              Icons.send,
              color: offWhite,
              size: 20,
